...
urlpatterns = [
    ...
    # Events pages
    path("events/", include("events.urls")),   # your events app
    path("events/student/", TemplateView.as_view(template_name="student_events.html"), name="student_events"),
    path("events/public/", TemplateView.as_view(template_name="public_events.html"), name="public_events"),
    path("events/resources/", TemplateView.as_view(template_name="student_resources.html"), name="student_resources"),
